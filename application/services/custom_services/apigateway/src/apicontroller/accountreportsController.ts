...
export class accountreportsController implements Controller {
    ...
    private initializeRoutes() {
        this.router.delete('/accountreports/:id', this.GpDelete);
this.router.get('/accountreports/get/search', this.GpSearch);
this.router.put('/accountreports', this.GpUpdate);
this.router.get('/accountreports/:id', this.GpGetNounById);
this.router.get('/accountreports', this.GpGetAllValues);
this.router.post('/accountreports', this.GpCreate);
this.router.get('/accountreports/userid/created_by', this.GpGetNounCreatedBy);
        //#@gepdelimeterone@#
        //#@ssofacebookapiroute@#
        //#@ssogithubapiroute@#
    }
...
public GpDelete(req: Request, res: Response) {
        ...
        new ApiAdapter().delete(Constant.MONKREPORTSURL + `${req.url}` )
...
public GpSearch(req: Request, res: Response) {
        ...
        new ApiAdapter().get(Constant.MONKREPORTSURL + `${req.url}` )
        .then((res: any) => res.response.json()).then(result => {
            switch(req.baseUrl) { case '/mobile': res.send(result); break; case '/web': res.send(result); break; default: res.send(null); }
...
public GpUpdate(req: Request, res: Response) {
        ...
        new ApiAdapter().put(Constant.MONKREPORTSURL + `${req.url}` , req.body)
        .then((res: any) => res.response.json()).then(result => {
            switch(req.baseUrl) { case '/mobile': res.send(result); break; case '/web': res.send(result); break; default: res.send(null); }
...
public GpCreate(req: Request, res: Response) {
        ...
        new ApiAdapter().post(Constant.MONKREPORTSURL + `${req.url}` , req.body)
        .then((res: any) => res.response.json()).then(result => {
            switch(req.baseUrl) { case '/mobile': res.send(result); break; case '/web': res.send(result); break; default: res.send(null); }
